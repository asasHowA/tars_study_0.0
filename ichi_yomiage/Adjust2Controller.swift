...
class Adjust2Controller: UIViewController {
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if segue.identifier == "toViewController" {
            ...
            if let xtap:Double = xkiroku.last, let ytap:Double = ykiroku.last{
                mainview.xTap2 = xtap
                mainview.yTap2 = ytap
                mainview.xTap1 = xTap1
                mainview.yTap1 = yTap1
            }else{
                print("nil error")
            }
        }
